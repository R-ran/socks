    ...
    <Layout>
      <div className="min-h-screen bg-[#e8e0ca] py-12 px-4 md:px-6">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold text-[#543313] mb-2 text-center">Privacy policy</h1>
          <p className="text-[#543313] mb-8">Last updated: October 10, 2025</p>
          
          <div className="space-y-8">
            <section>
              <p className="text-[#543313] leading-relaxed">
                Animalsox operates this store and website, including all related information, content, features, tools, products and services, in order to provide you, the customer, with a curated shopping experience (the "Services"). Animalsox is powered by Shopify, which enables us to provide the Services to you. This Privacy Policy describes how we collect, use, and disclose your personal information when you visit, use, or make a purchase or other transaction using the Services or otherwise communicate with us. If there is a conflict between our Terms of Service and this Privacy Policy, this Privacy Policy controls with respect to the collection, processing, and disclosure of your personal information.
              </p>
              <p className="text-[#543313] leading-relaxed mt-4">
                Please read this Privacy Policy carefully. By using and accessing any of the Services, you acknowledge that you have read this Privacy Policy and understand the collection, use, and disclosure of your information as described in this Privacy Policy.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-[#543313] mb-4">Personal Information We Collect or Process</h2>
              <p className="text-[#543313] leading-relaxed mb-3">
              ...
              <ul className="list-disc list-inside space-y-2 text-[#543313] ml-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#543313] mb-4">Personal Information Sources</h2>
              <p className="text-[#543313] leading-relaxed mb-3">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#543313] mb-4">How We Use Your Personal Information</h2>
              <p className="text-[#543313] leading-relaxed mb-3">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#543313] mb-4">How We Disclose Personal Information</h2>
              <p className="text-[#543313] leading-relaxed mb-3">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#543313] mb-4">Children's Data</h2>
              <p className="text-[#543313] leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#543313] mb-4">Security and Retention of Your Information</h2>
              <p className="text-[#543313] leading-relaxed mb-3">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#543313] mb-4">Your Rights and Choices</h2>
              <p className="text-[#543313] leading-relaxed mb-3">
              ...
              <ul className="list-disc list-inside space-y-2 text-[#543313] ml-4">
                ...
                <li><strong>Right to Opt out of Sale or Sharing for Targeted Advertising.</strong> Depending on where you reside, you may have a right to opt out of the "sale" or "share" of your personal information or to opt out of the processing of your personal information for purposes considered to be "targeted advertising", as defined in applicable privacy laws. You can exercise your rights to opt-out of those uses <a href="https://animalsox.co/pages/data-sharing-opt-out" className="text-[#d41872] underline hover:opacity-70">here</a>. Please note that if you visit our website with the Global Privacy Control opt-out preference signal enabled, depending on where you are, we will automatically treat this as a request to opt-out for the device and browser that you use to visit the website. If we are able to associate the device sending the signal to a Shopify account, we will apply the opt out request to the account as well. To learn more about Global Privacy Control, you can visit <a href="https://globalprivacycontrol.org/" className="text-[#d41872] underline hover:opacity-70">https://globalprivacycontrol.org/</a>. Other than the Global Privacy Control, we do not recognize other "Do Not Track" signals that may be sent from your web browser or device.</li>
              ...
              <div className="mt-4">
                <p className="text-[#543313] leading-relaxed mb-3">
                  <strong>If you reside in the UK or European Economic Area,</strong> and subject to exceptions and limitations provided by local law, you may exercise the following rights in addition to the rights outlined above:
                </p>
                <ul className="list-disc list-inside space-y-2 text-[#543313] ml-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#543313] mb-4">Changes to This Privacy Policy</h2>
              <p className="text-[#543313] leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#543313] mb-4">Contact</h2>
              <p className="text-[#543313] leading-relaxed">
                Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at <a href="mailto:contact@animalsocks.co" className="text-[#d41872] underline hover:opacity-70">contact@animalsocks.co</a> or contact us at Hribarov Prilaz 10, Building, Zagreb, 10000, HR. For the purpose of applicable data protection laws, we are the data controller of your personal information.
              </p>
            </section>
          </div>
        </div>
